...
class HyattBot(PointBotDriver):
    ...
    def mine_hyatt_points(self):
        funcname = str(self.mine_hyatt_points.__name__)
        ...
        try:
            kwargs = {
                    "step1": {
                        ...
                        "url": "https://world.hyatt.com/content/gp/en/sign-in.html",
                        "take_screenshot": 1,
                        "log_html": 1,
                        "capture_variable": "",
                        "output_capture": 1,
                ...
                "step2": {
                    ...
                    "argument_to_click": "//input[@name='username']",
                    "findby": By.XPATH,
                ...
                "step3": {
                    ...
                    "argument_to_click": "//input[@name='password']",
                    "findby": By.XPATH,
                 ...
                 "step4": {
                    "action": "click_text",
                    "description": "Entering Password",
                    "argument_to_click": "//input[@name='last_name']",
                    "findby": By.XPATH,
                ...
                "step5": {
                    ...
                    "argument_to_click": "//input[@value='SIGN IN']",
                    "findby": By.XPATH,
                    "take_screenshot": 1,
                    "log_html": 1,
                    "capture_variable": "",
            ...
            #             "action": "redirect",
            #             "description": "Going to Actitivty",
            #             "url": "https://www.hyatt.com/myaccount/rapid-rewards/recent-activity/details",
            #             "take_screenshot": 1,
            #             "log_html": 1,
            #             "capture_variable": "",
            #             "output_capture": 1,
            ...
            #     df = pd.concat(dflist)
            #     self.pbs.pbsavedf(f"{self.datapath}parsed/{self.point_bot_user}_hyatt_points_parsed.json",df=df)
