...
class MgmBot(PointBotDriver):
    ...
    def mine_mgm_points(self):
        funcname = str(self.mine_mgm_points.__name__)
        ...
        try:
            kwargs = {
                "step1": {
                    ...
                    "argument_to_click": "//span[contains(.,'Sign In')]",
                    "findby": By.XPATH,
                    "take_screenshot": 1,
                    "log_html": 1,
                    "capture_variable": "",
                ...
                "step2": {
                    ...
                    "argument_to_click": "email-widget",
                    "findby": By.ID,
                    "input_keys": str(self.rewards_user_email),
                    "take_screenshot": 1,
                    "log_html": 1,
                    "capture_variable": "",
                    "output_capture": 0,
                ...
                "step3": {
                    ...
                    "argument_to_click": "password-widget",
                    "findby": By.ID,
                ...
                #     "argument_to_click": "loginForm.lastName",
                #     "findby": By.ID,
                ...
                "step5": {
                    ...
                    "argument_to_click": "sign-in-widget",
                    "findby": By.ID,
                    "take_screenshot": 1,
                    "log_html": 1,
                    "capture_variable": "",
                    ...
                    "step6": {
                        ...
                        "url": "https://www.mgmresorts.com/en/sign-in/profile.html#/rewards",
                        "take_screenshot": 1,
                        "log_html": 1,
                        "capture_variable": "",
                        "output_capture": 1,
